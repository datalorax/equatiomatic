...
The equation is returned as a string. You can copy/paste it into your R Markdown
doc and it will render as

![](man/figures/eq1.png)

You can make copy/pasting easier by surrounding in `cat`. Or, alternatively,
preview the equation with `texPreview::tex_preview`.
