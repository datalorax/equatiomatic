...
test_that("Unstructured variance-covariances work as expected", {
  ...
  actual_hsb1 <- rm_ws("\\begin{aligned}\\operatorname{math}_{i}&\\simN\\left(\\mu,\\sigma^2\\right)\\\\\\mu&=\\alpha_{j[i]}+\\beta_{1}(\\operatorname{female})+\\beta_{2}(\\operatorname{ses})+\\beta_{3j[i]}(\\operatorname{minority})\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{j}\\\\&\\beta_{3j}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\mu_{\\alpha_{j}}\\\\&\\mu_{\\beta_{3j}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{cc}\\sigma^2_{\\alpha_{j}}&\\rho\\sigma_{\\alpha_{j}}\\sigma_{\\beta_{3j}}\\\\\\rho\\sigma_{\\beta_{3j}}\\sigma_{\\alpha_{j}}&\\sigma^2_{\\beta_{3j}}\\end{array}\\right)\\right)\\text{,forsch.idj=1,}\\dots\\text{,J}\\end{aligned}")
  ...
  actual_hsb2 <- rm_ws("\\begin{aligned}\\operatorname{math}_{i}&\\simN\\left(\\mu,\\sigma^2\\right)\\\\\\mu&=\\alpha_{j[i]}+\\beta_{1j[i]}(\\operatorname{female})+\\beta_{2j[i]}(\\operatorname{ses})+\\beta_{3}(\\operatorname{minority})\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{j}\\\\&\\beta_{1j}\\\\&\\beta_{2j}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\mu_{\\alpha_{j}}\\\\&\\mu_{\\beta_{1j}}\\\\&\\mu_{\\beta_{2j}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{ccc}\\sigma^2_{\\alpha_{j}}&\\rho\\sigma_{\\alpha_{j}}\\sigma_{\\beta_{1j}}&\\rho\\sigma_{\\alpha_{j}}\\sigma_{\\beta_{2j}}\\\\\\rho\\sigma_{\\beta_{1j}}\\sigma_{\\alpha_{j}}&\\sigma^2_{\\beta_{1j}}&\\rho\\sigma_{\\beta_{1j}}\\sigma_{\\beta_{2j}}\\\\\\rho\\sigma_{\\beta_{2j}}\\sigma_{\\alpha_{j}}&\\rho\\sigma_{\\beta_{2j}}\\sigma_{\\beta_{1j}}&\\sigma^2_{\\beta_{2j}}\\end{array}\\right)\\right)\\text{,forsch.idj=1,}\\dots\\text{,J}\\end{aligned}")
  ...
  actual_hsb3 <- rm_ws("\\begin{aligned}\\operatorname{math}_{i}&\\simN\\left(\\mu,\\sigma^2\\right)\\\\\\mu&=\\alpha_{j[i]}+\\beta_{1j[i]}(\\operatorname{female})+\\beta_{2j[i]}(\\operatorname{ses})+\\beta_{3}(\\operatorname{minority})+\\beta_{4j[i]}(\\operatorname{female}\\times\\operatorname{ses})\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{j}\\\\&\\beta_{1j}\\\\&\\beta_{2j}\\\\&\\beta_{4j}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\mu_{\\alpha_{j}}\\\\&\\mu_{\\beta_{1j}}\\\\&\\mu_{\\beta_{2j}}\\\\&\\mu_{\\beta_{4j}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{cccc}\\sigma^2_{\\alpha_{j}}&\\rho\\sigma_{\\alpha_{j}}\\sigma_{\\beta_{1j}}&\\rho\\sigma_{\\alpha_{j}}\\sigma_{\\beta_{2j}}&\\rho\\sigma_{\\alpha_{j}}\\sigma_{\\beta_{4j}}\\\\\\rho\\sigma_{\\beta_{1j}}\\sigma_{\\alpha_{j}}&\\sigma^2_{\\beta_{1j}}&\\rho\\sigma_{\\beta_{1j}}\\sigma_{\\beta_{2j}}&\\rho\\sigma_{\\beta_{1j}}\\sigma_{\\beta_{4j}}\\\\\\rho\\sigma_{\\beta_{2j}}\\sigma_{\\alpha_{j}}&\\rho\\sigma_{\\beta_{2j}}\\sigma_{\\beta_{1j}}&\\sigma^2_{\\beta_{2j}}&\\rho\\sigma_{\\beta_{2j}}\\sigma_{\\beta_{4j}}\\\\\\rho\\sigma_{\\beta_{4j}}\\sigma_{\\alpha_{j}}&\\rho\\sigma_{\\beta_{4j}}\\sigma_{\\beta_{1j}}&\\rho\\sigma_{\\beta_{4j}}\\sigma_{\\beta_{2j}}&\\sigma^2_{\\beta_{4j}}\\end{array}\\right)\\right)\\text{,forsch.idj=1,}\\dots\\text{,J}\\end{aligned}")
  ...
  actual_hsb4 <- rm_ws("\\begin{aligned}\\operatorname{math}_{i}&\\simN\\left(\\mu,\\sigma^2\\right)\\\\\\mu&=\\alpha_{j[i]}+\\beta_{1j[i]}(\\operatorname{female})+\\beta_{2j[i]}(\\operatorname{ses})+\\beta_{3j[i]}(\\operatorname{minority})+\\beta_{4j[i]}(\\operatorname{female}\\times\\operatorname{ses})\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{j}\\\\&\\beta_{1j}\\\\&\\beta_{2j}\\\\&\\beta_{3j}\\\\&\\beta_{4j}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\mu_{\\alpha_{j}}\\\\&\\mu_{\\beta_{1j}}\\\\&\\mu_{\\beta_{2j}}\\\\&\\mu_{\\beta_{3j}}\\\\&\\mu_{\\beta_{4j}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{ccccc}\\sigma^2_{\\alpha_{j}}&\\rho\\sigma_{\\alpha_{j}}\\sigma_{\\beta_{1j}}&\\rho\\sigma_{\\alpha_{j}}\\sigma_{\\beta_{2j}}&\\rho\\sigma_{\\alpha_{j}}\\sigma_{\\beta_{3j}}&\\rho\\sigma_{\\alpha_{j}}\\sigma_{\\beta_{4j}}\\\\\\rho\\sigma_{\\beta_{1j}}\\sigma_{\\alpha_{j}}&\\sigma^2_{\\beta_{1j}}&\\rho\\sigma_{\\beta_{1j}}\\sigma_{\\beta_{2j}}&\\rho\\sigma_{\\beta_{1j}}\\sigma_{\\beta_{3j}}&\\rho\\sigma_{\\beta_{1j}}\\sigma_{\\beta_{4j}}\\\\\\rho\\sigma_{\\beta_{2j}}\\sigma_{\\alpha_{j}}&\\rho\\sigma_{\\beta_{2j}}\\sigma_{\\beta_{1j}}&\\sigma^2_{\\beta_{2j}}&\\rho\\sigma_{\\beta_{2j}}\\sigma_{\\beta_{3j}}&\\rho\\sigma_{\\beta_{2j}}\\sigma_{\\beta_{4j}}\\\\\\rho\\sigma_{\\beta_{3j}}\\sigma_{\\alpha_{j}}&\\rho\\sigma_{\\beta_{3j}}\\sigma_{\\beta_{1j}}&\\rho\\sigma_{\\beta_{3j}}\\sigma_{\\beta_{2j}}&\\sigma^2_{\\beta_{3j}}&\\rho\\sigma_{\\beta_{3j}}\\sigma_{\\beta_{4j}}\\\\\\rho\\sigma_{\\beta_{4j}}\\sigma_{\\alpha_{j}}&\\rho\\sigma_{\\beta_{4j}}\\sigma_{\\beta_{1j}}&\\rho\\sigma_{\\beta_{4j}}\\sigma_{\\beta_{2j}}&\\rho\\sigma_{\\beta_{4j}}\\sigma_{\\beta_{3j}}&\\sigma^2_{\\beta_{4j}}\\end{array}\\right)\\right)\\text{,forsch.idj=1,}\\dots\\text{,J}\\end{aligned}")
  ...
  actual_long1 <- rm_ws("\\begin{aligned}\\operatorname{score}_{i}&\\simN\\left(\\alpha_{j[i],k[i],l[i]}+\\beta_{1j[i],k[i],l[i]}(\\operatorname{wave}),\\sigma^2\\right)\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{j}\\\\&\\beta_{1j}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\mu_{\\alpha_{j}}\\\\&\\mu_{\\beta_{1j}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{cc}\\sigma^2_{\\alpha_{j}}&\\rho\\sigma_{\\alpha_{j}}\\sigma_{\\beta_{1j}}\\\\\\rho\\sigma_{\\beta_{1j}}\\sigma_{\\alpha_{j}}&\\sigma^2_{\\beta_{1j}}\\end{array}\\right)\\right)\\text{,forsidj=1,}\\dots\\text{,J}\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{k}\\\\&\\beta_{1k}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\mu_{\\alpha_{k}}\\\\&\\mu_{\\beta_{1k}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{cc}\\sigma^2_{\\alpha_{k}}&\\rho\\sigma_{\\alpha_{k}}\\sigma_{\\beta_{1k}}\\\\\\rho\\sigma_{\\beta_{1k}}\\sigma_{\\alpha_{k}}&\\sigma^2_{\\beta_{1k}}\\end{array}\\right)\\right)\\text{,forschoolk=1,}\\dots\\text{,K}\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{l}\\\\&\\beta_{1l}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\mu_{\\alpha_{l}}\\\\&\\mu_{\\beta_{1l}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{cc}\\sigma^2_{\\alpha_{l}}&\\rho\\sigma_{\\alpha_{l}}\\sigma_{\\beta_{1l}}\\\\\\rho\\sigma_{\\beta_{1l}}\\sigma_{\\alpha_{l}}&\\sigma^2_{\\beta_{1l}}\\end{array}\\right)\\right)\\text{,fordistrictl=1,}\\dots\\text{,L}\\end{aligned}")
...
test_that("Group-level predictors work as expected", {
  ...
  actual_long2 <- rm_ws("\\begin{aligned}\\operatorname{score}_{i}&\\simN\\left(\\alpha_{j[i],k[i],l[i]}+\\beta_{1j[i],k[i],l[i]}(\\operatorname{wave}),\\sigma^2\\right)\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{j}\\\\&\\beta_{1j}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\gamma_{0}^{\\alpha}+\\gamma_{1k[i]}^{\\alpha}(\\operatorname{group}_{\\operatorname{low}})+\\gamma_{2k[i]}^{\\alpha}(\\operatorname{group}_{\\operatorname{medium}})+\\gamma_{3k[i],l[i]}^{\\alpha}(\\operatorname{treatment}_{\\operatorname{1}})\\\\&\\mu_{\\beta_{1j}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{cc}\\sigma^2_{\\alpha_{j}}&\\rho\\sigma_{\\alpha_{j}}\\sigma_{\\beta_{1j}}\\\\\\rho\\sigma_{\\beta_{1j}}\\sigma_{\\alpha_{j}}&\\sigma^2_{\\beta_{1j}}\\end{array}\\right)\\right)\\text{,forsidj=1,}\\dots\\text{,J}\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{k}\\\\&\\beta_{1k}\\\\&\\gamma_{1k}\\\\&\\gamma_{2k}\\\\&\\gamma_{3k}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\mu_{\\alpha_{k}}\\\\&\\mu_{\\beta_{1k}}\\\\&\\mu_{\\gamma_{1k}}\\\\&\\mu_{\\gamma_{2k}}\\\\&\\mu_{\\gamma_{3k}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{ccccc}\\sigma^2_{\\alpha_{k}}&\\rho\\sigma_{\\alpha_{k}}\\sigma_{\\beta_{1k}}&\\rho\\sigma_{\\alpha_{k}}\\sigma_{\\gamma_{1k}}&\\rho\\sigma_{\\alpha_{k}}\\sigma_{\\gamma_{2k}}&\\rho\\sigma_{\\alpha_{k}}\\sigma_{\\gamma_{3k}}\\\\\\rho\\sigma_{\\beta_{1k}}\\sigma_{\\alpha_{k}}&\\sigma^2_{\\beta_{1k}}&\\rho\\sigma_{\\beta_{1k}}\\sigma_{\\gamma_{1k}}&\\rho\\sigma_{\\beta_{1k}}\\sigma_{\\gamma_{2k}}&\\rho\\sigma_{\\beta_{1k}}\\sigma_{\\gamma_{3k}}\\\\\\rho\\sigma_{\\gamma_{1k}}\\sigma_{\\alpha_{k}}&\\rho\\sigma_{\\gamma_{1k}}\\sigma_{\\beta_{1k}}&\\sigma^2_{\\gamma_{1k}}&\\rho\\sigma_{\\gamma_{1k}}\\sigma_{\\gamma_{2k}}&\\rho\\sigma_{\\gamma_{1k}}\\sigma_{\\gamma_{3k}}\\\\\\rho\\sigma_{\\gamma_{2k}}\\sigma_{\\alpha_{k}}&\\rho\\sigma_{\\gamma_{2k}}\\sigma_{\\beta_{1k}}&\\rho\\sigma_{\\gamma_{2k}}\\sigma_{\\gamma_{1k}}&\\sigma^2_{\\gamma_{2k}}&\\rho\\sigma_{\\gamma_{2k}}\\sigma_{\\gamma_{3k}}\\\\\\rho\\sigma_{\\gamma_{3k}}\\sigma_{\\alpha_{k}}&\\rho\\sigma_{\\gamma_{3k}}\\sigma_{\\beta_{1k}}&\\rho\\sigma_{\\gamma_{3k}}\\sigma_{\\gamma_{1k}}&\\rho\\sigma_{\\gamma_{3k}}\\sigma_{\\gamma_{2k}}&\\sigma^2_{\\gamma_{3k}}\\end{array}\\right)\\right)\\text{,forschoolk=1,}\\dots\\text{,K}\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{l}\\\\&\\beta_{1l}\\\\&\\gamma_{3l}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\mu_{\\alpha_{l}}\\\\&\\mu_{\\beta_{1l}}\\\\&\\mu_{\\gamma_{3l}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{ccc}\\sigma^2_{\\alpha_{l}}&\\rho\\sigma_{\\alpha_{l}}\\sigma_{\\beta_{1l}}&\\rho\\sigma_{\\alpha_{l}}\\sigma_{\\gamma_{3l}}\\\\\\rho\\sigma_{\\beta_{1l}}\\sigma_{\\alpha_{l}}&\\sigma^2_{\\beta_{1l}}&\\rho\\sigma_{\\beta_{1l}}\\sigma_{\\gamma_{3l}}\\\\\\rho\\sigma_{\\gamma_{3l}}\\sigma_{\\alpha_{l}}&\\rho\\sigma_{\\gamma_{3l}}\\sigma_{\\beta_{1l}}&\\sigma^2_{\\gamma_{3l}}\\end{array}\\right)\\right)\\text{,fordistrictl=1,}\\dots\\text{,L}\\end{aligned}")
  ...
  actual_long3 <- rm_ws("\\begin{aligned}\\operatorname{score}_{i}&\\simN\\left(\\alpha_{j[i],k[i],l[i]}+\\beta_{1j[i],k[i],l[i]}(\\operatorname{wave}),\\sigma^2\\right)\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{j}\\\\&\\beta_{1j}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\gamma_{0}^{\\alpha}+\\gamma_{1k[i]}^{\\alpha}(\\operatorname{group}_{\\operatorname{low}})+\\gamma_{2k[i]}^{\\alpha}(\\operatorname{group}_{\\operatorname{medium}})+\\gamma_{3k[i],l[i]}^{\\alpha}(\\operatorname{treatment}_{\\operatorname{1}})\\\\&\\mu_{\\beta_{1j}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{cc}\\sigma^2_{\\alpha_{j}}&\\rho\\sigma_{\\alpha_{j}}\\sigma_{\\beta_{1j}}\\\\\\rho\\sigma_{\\beta_{1j}}\\sigma_{\\alpha_{j}}&\\sigma^2_{\\beta_{1j}}\\end{array}\\right)\\right)\\text{,forsidj=1,}\\dots\\text{,J}\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{k}\\\\&\\beta_{1k}\\\\&\\gamma_{1k}\\\\&\\gamma_{2k}\\\\&\\gamma_{3k}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\gamma_{0}^{\\alpha}+\\gamma_{1l[i]}^{\\alpha}(\\operatorname{prop\\_low})\\\\&\\mu_{\\beta_{1k}}\\\\&\\mu_{\\gamma_{1k}}\\\\&\\mu_{\\gamma_{2k}}\\\\&\\mu_{\\gamma_{3k}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{ccccc}\\sigma^2_{\\alpha_{k}}&\\rho\\sigma_{\\alpha_{k}}\\sigma_{\\beta_{1k}}&\\rho\\sigma_{\\alpha_{k}}\\sigma_{\\gamma_{1k}}&\\rho\\sigma_{\\alpha_{k}}\\sigma_{\\gamma_{2k}}&\\rho\\sigma_{\\alpha_{k}}\\sigma_{\\gamma_{3k}}\\\\\\rho\\sigma_{\\beta_{1k}}\\sigma_{\\alpha_{k}}&\\sigma^2_{\\beta_{1k}}&\\rho\\sigma_{\\beta_{1k}}\\sigma_{\\gamma_{1k}}&\\rho\\sigma_{\\beta_{1k}}\\sigma_{\\gamma_{2k}}&\\rho\\sigma_{\\beta_{1k}}\\sigma_{\\gamma_{3k}}\\\\\\rho\\sigma_{\\gamma_{1k}}\\sigma_{\\alpha_{k}}&\\rho\\sigma_{\\gamma_{1k}}\\sigma_{\\beta_{1k}}&\\sigma^2_{\\gamma_{1k}}&\\rho\\sigma_{\\gamma_{1k}}\\sigma_{\\gamma_{2k}}&\\rho\\sigma_{\\gamma_{1k}}\\sigma_{\\gamma_{3k}}\\\\\\rho\\sigma_{\\gamma_{2k}}\\sigma_{\\alpha_{k}}&\\rho\\sigma_{\\gamma_{2k}}\\sigma_{\\beta_{1k}}&\\rho\\sigma_{\\gamma_{2k}}\\sigma_{\\gamma_{1k}}&\\sigma^2_{\\gamma_{2k}}&\\rho\\sigma_{\\gamma_{2k}}\\sigma_{\\gamma_{3k}}\\\\\\rho\\sigma_{\\gamma_{3k}}\\sigma_{\\alpha_{k}}&\\rho\\sigma_{\\gamma_{3k}}\\sigma_{\\beta_{1k}}&\\rho\\sigma_{\\gamma_{3k}}\\sigma_{\\gamma_{1k}}&\\rho\\sigma_{\\gamma_{3k}}\\sigma_{\\gamma_{2k}}&\\sigma^2_{\\gamma_{3k}}\\end{array}\\right)\\right)\\text{,forschoolk=1,}\\dots\\text{,K}\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{l}\\\\&\\beta_{1l}\\\\&\\gamma_{3l}\\\\&\\gamma_{1l}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\mu_{\\alpha_{l}}\\\\&\\mu_{\\beta_{1l}}\\\\&\\mu_{\\gamma_{3l}}\\\\&\\mu_{\\gamma_{1l}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{cccc}\\sigma^2_{\\alpha_{l}}&\\rho\\sigma_{\\alpha_{l}}\\sigma_{\\beta_{1l}}&\\rho\\sigma_{\\alpha_{l}}\\sigma_{\\gamma_{3l}}&\\rho\\sigma_{\\alpha_{l}}\\sigma_{\\gamma_{1l}}\\\\\\rho\\sigma_{\\beta_{1l}}\\sigma_{\\alpha_{l}}&\\sigma^2_{\\beta_{1l}}&\\rho\\sigma_{\\beta_{1l}}\\sigma_{\\gamma_{3l}}&\\rho\\sigma_{\\beta_{1l}}\\sigma_{\\gamma_{1l}}\\\\\\rho\\sigma_{\\gamma_{3l}}\\sigma_{\\alpha_{l}}&\\rho\\sigma_{\\gamma_{3l}}\\sigma_{\\beta_{1l}}&\\sigma^2_{\\gamma_{3l}}&\\rho\\sigma_{\\gamma_{3l}}\\sigma_{\\gamma_{1l}}\\\\\\rho\\sigma_{\\gamma_{1l}}\\sigma_{\\alpha_{l}}&\\rho\\sigma_{\\gamma_{1l}}\\sigma_{\\beta_{1l}}&\\rho\\sigma_{\\gamma_{1l}}\\sigma_{\\gamma_{3l}}&\\sigma^2_{\\gamma_{1l}}\\end{array}\\right)\\right)\\text{,fordistrictl=1,}\\dots\\text{,L}\\end{aligned}")
  ...
  actual_long4 <- rm_ws("\\begin{aligned}\\operatorname{score}_{i}&\\simN\\left(\\alpha_{j[i],k[i],l[i]}+\\beta_{1j[i],k[i],l[i]}(\\operatorname{wave}),\\sigma^2\\right)\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{j}\\\\&\\beta_{1j}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\gamma_{0}^{\\alpha}+\\gamma_{1}^{\\alpha}(\\operatorname{group}_{\\operatorname{low}})+\\gamma_{2}^{\\alpha}(\\operatorname{group}_{\\operatorname{medium}})+\\gamma_{3k[i]}^{\\alpha}(\\operatorname{treatment}_{\\operatorname{1}})\\\\&\\mu_{\\beta_{1j}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{cc}\\sigma^2_{\\alpha_{j}}&\\rho\\sigma_{\\alpha_{j}}\\sigma_{\\beta_{1j}}\\\\\\rho\\sigma_{\\beta_{1j}}\\sigma_{\\alpha_{j}}&\\sigma^2_{\\beta_{1j}}\\end{array}\\right)\\right)\\text{,forsidj=1,}\\dots\\text{,J}\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{k}\\\\&\\beta_{1k}\\\\&\\gamma_{3k}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\gamma_{0}^{\\alpha}+\\gamma_{1}^{\\alpha}(\\operatorname{prop\\_low})\\\\&\\mu_{\\beta_{1k}}\\\\&\\mu_{\\gamma_{3k}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{ccc}\\sigma^2_{\\alpha_{k}}&\\rho\\sigma_{\\alpha_{k}}\\sigma_{\\beta_{1k}}&\\rho\\sigma_{\\alpha_{k}}\\sigma_{\\gamma_{3k}}\\\\\\rho\\sigma_{\\beta_{1k}}\\sigma_{\\alpha_{k}}&\\sigma^2_{\\beta_{1k}}&\\rho\\sigma_{\\beta_{1k}}\\sigma_{\\gamma_{3k}}\\\\\\rho\\sigma_{\\gamma_{3k}}\\sigma_{\\alpha_{k}}&\\rho\\sigma_{\\gamma_{3k}}\\sigma_{\\beta_{1k}}&\\sigma^2_{\\gamma_{3k}}\\end{array}\\right)\\right)\\text{,forschoolk=1,}\\dots\\text{,K}\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{l}\\\\&\\beta_{1l}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\gamma_{0}^{\\alpha}+\\gamma_{1}^{\\alpha}(\\operatorname{dist\\_mean})\\\\&\\mu_{\\beta_{1l}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{cc}\\sigma^2_{\\alpha_{l}}&\\rho\\sigma_{\\alpha_{l}}\\sigma_{\\beta_{1l}}\\\\\\rho\\sigma_{\\beta_{1l}}\\sigma_{\\alpha_{l}}&\\sigma^2_{\\beta_{1l}}\\end{array}\\right)\\right)\\text{,fordistrictl=1,}\\dots\\text{,L}\\end{aligned}")
...
test_that("Interactions work as expected", {
  ...
  actual_l2_long_int <- rm_ws("\\begin{aligned}\\operatorname{score}_{i}&\\simN\\left(\\alpha_{j[i],k[i],l[i]},\\sigma^2\\right)\\\\\\alpha_{j}&\\simN\\left(\\gamma_{0}^{\\alpha}+\\gamma_{1k[i],l[i]}^{\\alpha}(\\operatorname{treatment}_{\\operatorname{1}})+\\gamma_{2l[i]}^{\\alpha}(\\operatorname{group}_{\\operatorname{low}})+\\gamma_{3l[i]}^{\\alpha}(\\operatorname{group}_{\\operatorname{medium}})+\\gamma_{4l[i]}^{\\alpha}(\\operatorname{group}_{\\operatorname{low}}\\times\\operatorname{treatment}_{\\operatorname{1}})+\\gamma_{5l[i]}^{\\alpha}(\\operatorname{group}_{\\operatorname{medium}}\\times\\operatorname{treatment}_{\\operatorname{1}}),\\sigma^2_{\\alpha_{j}}\\right)\\text{,forsidj=1,}\\dots\\text{,J}\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{k}\\\\&\\gamma_{1k}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\mu_{\\alpha_{k}}\\\\&\\mu_{\\gamma_{1k}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{cc}\\sigma^2_{\\alpha_{k}}&\\rho\\sigma_{\\alpha_{k}}\\sigma_{\\gamma_{1k}}\\\\\\rho\\sigma_{\\gamma_{1k}}\\sigma_{\\alpha_{k}}&\\sigma^2_{\\gamma_{1k}}\\end{array}\\right)\\right)\\text{,forschoolk=1,}\\dots\\text{,K}\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{l}\\\\&\\gamma_{1l}\\\\&\\gamma_{2l}\\\\&\\gamma_{3l}\\\\&\\gamma_{4l}\\\\&\\gamma_{5l}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\mu_{\\alpha_{l}}\\\\&\\mu_{\\gamma_{1l}}\\\\&\\mu_{\\gamma_{2l}}\\\\&\\mu_{\\gamma_{3l}}\\\\&\\mu_{\\gamma_{4l}}\\\\&\\mu_{\\gamma_{5l}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{cccccc}\\sigma^2_{\\alpha_{l}}&\\rho\\sigma_{\\alpha_{l}}\\sigma_{\\gamma_{1l}}&\\rho\\sigma_{\\alpha_{l}}\\sigma_{\\gamma_{2l}}&\\rho\\sigma_{\\alpha_{l}}\\sigma_{\\gamma_{3l}}&\\rho\\sigma_{\\alpha_{l}}\\sigma_{\\gamma_{4l}}&\\rho\\sigma_{\\alpha_{l}}\\sigma_{\\gamma_{5l}}\\\\\\rho\\sigma_{\\gamma_{1l}}\\sigma_{\\alpha_{l}}&\\sigma^2_{\\gamma_{1l}}&\\rho\\sigma_{\\gamma_{1l}}\\sigma_{\\gamma_{2l}}&\\rho\\sigma_{\\gamma_{1l}}\\sigma_{\\gamma_{3l}}&\\rho\\sigma_{\\gamma_{1l}}\\sigma_{\\gamma_{4l}}&\\rho\\sigma_{\\gamma_{1l}}\\sigma_{\\gamma_{5l}}\\\\\\rho\\sigma_{\\gamma_{2l}}\\sigma_{\\alpha_{l}}&\\rho\\sigma_{\\gamma_{2l}}\\sigma_{\\gamma_{1l}}&\\sigma^2_{\\gamma_{2l}}&\\rho\\sigma_{\\gamma_{2l}}\\sigma_{\\gamma_{3l}}&\\rho\\sigma_{\\gamma_{2l}}\\sigma_{\\gamma_{4l}}&\\rho\\sigma_{\\gamma_{2l}}\\sigma_{\\gamma_{5l}}\\\\\\rho\\sigma_{\\gamma_{3l}}\\sigma_{\\alpha_{l}}&\\rho\\sigma_{\\gamma_{3l}}\\sigma_{\\gamma_{1l}}&\\rho\\sigma_{\\gamma_{3l}}\\sigma_{\\gamma_{2l}}&\\sigma^2_{\\gamma_{3l}}&\\rho\\sigma_{\\gamma_{3l}}\\sigma_{\\gamma_{4l}}&\\rho\\sigma_{\\gamma_{3l}}\\sigma_{\\gamma_{5l}}\\\\\\rho\\sigma_{\\gamma_{4l}}\\sigma_{\\alpha_{l}}&\\rho\\sigma_{\\gamma_{4l}}\\sigma_{\\gamma_{1l}}&\\rho\\sigma_{\\gamma_{4l}}\\sigma_{\\gamma_{2l}}&\\rho\\sigma_{\\gamma_{4l}}\\sigma_{\\gamma_{3l}}&\\sigma^2_{\\gamma_{4l}}&\\rho\\sigma_{\\gamma_{4l}}\\sigma_{\\gamma_{5l}}\\\\\\rho\\sigma_{\\gamma_{5l}}\\sigma_{\\alpha_{l}}&\\rho\\sigma_{\\gamma_{5l}}\\sigma_{\\gamma_{1l}}&\\rho\\sigma_{\\gamma_{5l}}\\sigma_{\\gamma_{2l}}&\\rho\\sigma_{\\gamma_{5l}}\\sigma_{\\gamma_{3l}}&\\rho\\sigma_{\\gamma_{5l}}\\sigma_{\\gamma_{4l}}&\\sigma^2_{\\gamma_{5l}}\\end{array}\\right)\\right)\\text{,fordistrictl=1,}\\dots\\text{,L}\\end{aligned}")
  ...
  actual_cl_long1 <- rm_ws("\\begin{aligned}\\operatorname{score}_{i}&\\simN\\left(\\alpha_{j[i],k[i],l[i]}+\\beta_{0j[i]}(\\operatorname{wave}),\\sigma^2\\right)\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{j}\\\\&\\beta_{0j}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\gamma_{0}^{\\alpha}+\\gamma_{1}^{\\alpha}(\\operatorname{treatment}_{\\operatorname{1}})\\\\&\\gamma^{\\beta_{0}}_{0}+\\gamma^{\\beta_{0}}_{1}(\\operatorname{treatment}_{\\operatorname{1}})\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{cc}\\sigma^2_{\\alpha_{j}}&\\rho\\sigma_{\\alpha_{j}}\\sigma_{\\beta_{0j}}\\\\\\rho\\sigma_{\\beta_{0j}}\\sigma_{\\alpha_{j}}&\\sigma^2_{\\beta_{0j}}\\end{array}\\right)\\right)\\text{,forsidj=1,}\\dots\\text{,J}\\\\\\alpha_{k}&\\simN\\left(\\mu_{\\alpha_{k}},\\sigma^2_{\\alpha_{k}}\\right)\\text{,forschoolk=1,}\\dots\\text{,K}\\\\\\alpha_{l}&\\simN\\left(\\mu_{\\alpha_{l}},\\sigma^2_{\\alpha_{l}}\\right)\\text{,fordistrictl=1,}\\dots\\text{,L}\\end{aligned}")
  ...
  actual_cl_long3 <- rm_ws("\\begin{aligned}\\operatorname{score}_{i}&\\simN\\left(\\alpha_{j[i],k[i],l[i]}+\\beta_{1j[i],k[i],l[i]}(\\operatorname{wave}),\\sigma^2\\right)\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{j}\\\\&\\beta_{1j}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\gamma_{0}^{\\alpha}+\\gamma_{1}^{\\alpha}(\\operatorname{group}_{\\operatorname{low}})+\\gamma_{2}^{\\alpha}(\\operatorname{group}_{\\operatorname{medium}})+\\gamma_{3l[i]}^{\\alpha}(\\operatorname{treatment}_{\\operatorname{1}})+\\gamma_{4}^{\\alpha}(\\operatorname{group}_{\\operatorname{low}}\\times\\operatorname{treatment}_{\\operatorname{1}})+\\gamma_{5}^{\\alpha}(\\operatorname{group}_{\\operatorname{medium}}\\times\\operatorname{treatment}_{\\operatorname{1}})\\\\&\\gamma^{\\beta_{1}}_{0}+\\gamma^{\\beta_{1}}_{1}(\\operatorname{group}_{\\operatorname{low}})+\\gamma^{\\beta_{1}}_{2}(\\operatorname{group}_{\\operatorname{medium}})+\\gamma^{\\beta_{1}}_{3}(\\operatorname{treatment}_{\\operatorname{1}})+\\gamma^{\\beta_{1}}_{4}(\\operatorname{group}_{\\operatorname{low}}\\times\\operatorname{treatment}_{\\operatorname{1}})+\\gamma^{\\beta_{1}}_{5}(\\operatorname{group}_{\\operatorname{medium}}\\times\\operatorname{treatment}_{\\operatorname{1}})\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{cc}\\sigma^2_{\\alpha_{j}}&\\rho\\sigma_{\\alpha_{j}}\\sigma_{\\beta_{1j}}\\\\\\rho\\sigma_{\\beta_{1j}}\\sigma_{\\alpha_{j}}&\\sigma^2_{\\beta_{1j}}\\end{array}\\right)\\right)\\text{,forsidj=1,}\\dots\\text{,J}\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{k}\\\\&\\beta_{1k}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\gamma_{0}^{\\alpha}+\\gamma_{1}^{\\alpha}(\\operatorname{prop\\_low})+\\gamma_{2}^{\\alpha}(\\operatorname{prop\\_low}\\times\\operatorname{treatment}_{\\operatorname{1}})\\\\&\\gamma^{\\beta_{1}}_{0}+\\gamma^{\\beta_{1}}_{2}(\\operatorname{prop\\_low})+\\gamma^{\\beta_{1}}_{1}(\\operatorname{prop\\_low}\\times\\operatorname{treatment}_{\\operatorname{1}})\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{cc}\\sigma^2_{\\alpha_{k}}&\\rho\\sigma_{\\alpha_{k}}\\sigma_{\\beta_{1k}}\\\\\\rho\\sigma_{\\beta_{1k}}\\sigma_{\\alpha_{k}}&\\sigma^2_{\\beta_{1k}}\\end{array}\\right)\\right)\\text{,forschoolk=1,}\\dots\\text{,K}\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{l}\\\\&\\beta_{1l}\\\\&\\gamma_{3l}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\mu_{\\alpha_{l}}\\\\&\\mu_{\\beta_{1l}}\\\\&\\mu_{\\gamma_{3l}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{ccc}\\sigma^2_{\\alpha_{l}}&\\rho\\sigma_{\\alpha_{l}}\\sigma_{\\beta_{1l}}&\\rho\\sigma_{\\alpha_{l}}\\sigma_{\\gamma_{3l}}\\\\\\rho\\sigma_{\\beta_{1l}}\\sigma_{\\alpha_{l}}&\\sigma^2_{\\beta_{1l}}&\\rho\\sigma_{\\beta_{1l}}\\sigma_{\\gamma_{3l}}\\\\\\rho\\sigma_{\\gamma_{3l}}\\sigma_{\\alpha_{l}}&\\rho\\sigma_{\\gamma_{3l}}\\sigma_{\\beta_{1l}}&\\sigma^2_{\\gamma_{3l}}\\end{array}\\right)\\right)\\text{,fordistrictl=1,}\\dots\\text{,L}\\end{aligned}")
...
test_that("Alternate random effect VCV structures work", {
  ...
  actual_hsb_doublegroup <- rm_ws("\\begin{aligned}\\operatorname{math}_{i}&\\simN\\left(\\mu,\\sigma^2\\right)\\\\\\mu&=\\alpha_{j[i],k[i]}+\\beta_{1j[i]}(\\operatorname{minority})+\\beta_{2k[i]}(\\operatorname{female})+\\beta_{3}(\\operatorname{female}\\times\\operatorname{minority})\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{j}\\\\&\\beta_{1j}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\mu_{\\alpha_{j}}\\\\&\\mu_{\\beta_{1j}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{cc}\\sigma^2_{\\alpha_{j}}&\\rho\\sigma_{\\alpha_{j}}\\sigma_{\\beta_{1j}}\\\\\\rho\\sigma_{\\beta_{1j}}\\sigma_{\\alpha_{j}}&\\sigma^2_{\\beta_{1j}}\\end{array}\\right)\\right)\\text{,forsch.idj=1,}\\dots\\text{,J}\\\\\\left(\\begin{array}{c}\\begin{aligned}&\\alpha_{k}\\\\&\\beta_{2k}\\end{aligned}\\end{array}\\right)&\\simN\\left(\\left(\\begin{array}{c}\\begin{aligned}&\\mu_{\\alpha_{k}}\\\\&\\mu_{\\beta_{2k}}\\end{aligned}\\end{array}\\right),\\left(\\begin{array}{cc}\\sigma^2_{\\alpha_{k}}&\\rho\\sigma_{\\alpha_{k}}\\sigma_{\\beta_{2k}}\\\\\\rho\\sigma_{\\beta_{2k}}\\sigma_{\\alpha_{k}}&\\sigma^2_{\\beta_{2k}}\\end{array}\\right)\\right)\\text{,forsch.id.1k=1,}\\dots\\text{,K}\\end{aligned}")
